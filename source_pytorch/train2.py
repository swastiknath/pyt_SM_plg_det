...
from model2 import MulticlassClassifier
...
def _get_train_data_loader(batch_size, training_dir):
    ...
    train_data = pd.read_csv(os.path.join(training_dir, "multi_train.csv"), header=None, names=None)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dim', type=int, default=4, metavar='O', 
